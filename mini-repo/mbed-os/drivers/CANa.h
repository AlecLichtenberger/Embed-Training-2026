...
enum CanIrqType { RxIrq, TxIrq, EwIrq, DoIrq, WuIrq, EpIrq, AlIrq, BeIrq, IdIrq };
...
public:
    ...
    void attach(Callback<void()> /*func*/, CanIrqType /*type*/ = RxIrq) {}
    template <typename T>
    void attach(T* obj, void (T::*method)(), CanIrqType type = RxIrq) {}
};
